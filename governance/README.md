...
| file | what |
|---|---|
| [`CONSTITUTION.md`](./CONSTITUTION.md) | **Authoritative** constitution, **v2.1** (Preamble + Articles I–XXIII + claim/licence matrix + status vocabulary). |
...
| [`CONSTITUTION_SELF_AUDIT.md`](./CONSTITUTION_SELF_AUDIT.md) | Adversarial adoption-gate audit; B1–B8 now RESOLVED in v2.1. |
